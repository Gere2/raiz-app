/**
 * seed-meeting-combos.js  (v2 – Mini combos with customizable slots)
 *
 * Run with: node scripts/seed-meeting-combos.js
 *
...
const serviceAccountPath = process.env.GOOGLE_APPLICATION_CREDENTIALS || path.resolve(__dirname, "../apps/pos/secrets/raizygrano-admin.json");
