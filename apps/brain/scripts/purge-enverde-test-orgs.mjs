...
const TARGET_ORG_IDS = [
  ...
  "cafe-test-resumen-prepiloto-ehzy2r", // e2e fuentes resumen POS/manual/estimate (2026-06-11)
  "cafe-test-vinculo-prepiloto-1qruee", // e2e vinculación producto TPV↔escandallo (2026-06-11)
];
